...
<body>
  <jsp:include page="head.jsp" flush="true"/>
   ...
   <img class="banner-img" src="../../res/img/banner4.jpg">
   
   

  <div class="content whisper-content" style="background-color:rgb(133,155,126); " >
  ...
  <%
   ...
   %>
	  <div class="container" style="text-align:right">
	    <a href="../forms/club_activity_tip.jsp" class="btn btn-info" role="button">我要发帖</a>
      </div> 
   <%  
    } 
   %>
    ...
    <div class="cont">
      <div class="whisper-list">
      	...
      	<%
	        ...
	        ResultSet rs1=stmt1.executeQuery("select * from club_activity order by activity_id desc;");
	      	while(rs1.next() ) {   
        ...
        <div class="item-box" style="background-color:rgb(217,217,216); opacity:0.9;" >
          <div class="item">
            <div class="whisper-title">
	          ...
	          <p class="activity_name">活动名称 ： <%=rs1.getString(3) %> </p>
	          <p class="activity_content">活动介绍 ： <%=rs1.getString(4) %> </p>
	          <p class="department">活动举办部门 ： <%=rs1.getString(5) %> </p>
              <p class="activity_location">活动地点 ： <%=rs1.getString(6) %> </p>
			  <p class="activity_datetime">活动时间 ： <%=rs1.getString(7) %> </p>	
            ...
            <div class="op-list">  
              ...
              <%
	          	  ...
	          	  ResultSet rs5=stmt5.executeQuery("select count(*) from club_activity_comment where activity_id = " + rs1.getInt(1)  +  ";");
	          	  rs5.next();  
              %>
          ...
          <div class="review-version layui-hide">
              ...
              int activity_id = rs1.getInt(1);
              String user_net_id = session.getAttribute("login_id").toString();
              if (comment_content != null && comment_content != "") {
            	  Statement stm=connect.createStatement();
      			  String sqlq="select * from club_activity_comment order by comment_id desc limit 1;";
      			  ...
      			  String sql="insert into club_activity_comment(comment_id,activity_id,user_net_id,comment_content) values(?,?,?,?)";
      		    ...
      		    <script type="text/javascript">
      		    	window.location.replace("club_activity.jsp");
      		    </script><%    
              }
	          ...
	          ResultSet rs3=stmt3.executeQuery("select * from club_activity_comment where activity_id = " + rs1.getInt(1)  +  ";");
	      	  while(rs3.next() ) { 
  ...
  <div class="footer-wrap" style="background-color:rgb(133,155,126); " >
