...
<BODY BGCOLOR="white">
	...
	<% 
		...
		String book_name=mySmartUpload.getRequest().getParameter("material_name");
		String comment=mySmartUpload.getRequest().getParameter("comment");
		int user_net_id=Integer.parseInt(netid10);


        Statement stm=connect.createStatement();
        String sqlq="select * from study_online order by book_id desc limit 1;";
        ...
        String sql="insert into study_online(book_id,user_net_id,book_name,description,time) values(?,?,?,?,?)";
        ...
        ResultSet rs_query = stmt.executeQuery("SELECT * FROM study_online order by book_id desc limit 1");
 	   ...
 	   <script type="text/javascript">
            window.location.replace("../views/study_online.jsp");
       </script>
